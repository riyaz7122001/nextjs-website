    ...
    return (
        <section id="features" className="flex md:flex-row flex-col sm:py-16 py-6 relative">
            <div className="flex flex-col flex-1 justify-center items-start">
                ...
                <p className={`${styles.paragraph} max-w-[475px] mt-5`}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestiae sunt,
                    blanditiis hic reiciendis nam sapiente totam! Debitis autem quo, deleniti dolorum, dolor blanditiis eveniet minus consequatur
                    reiciendis labore, perferendis laboriosam.
                </p>
                <Button styles="mt-10" />
            </div>
